...
SWEP.Gun = ("m9_bayonet") -- must be the name of your swep but NO CAPITALS!
SWEP.Category				= "Spectracus's War Chest"
SWEP.Author				= "Spectracus"
SWEP.Contact				= ""
SWEP.Purpose				= "Old M16-series rifle bayonet used as a combat knife. Deadly at close range."
SWEP.PrintName				= "M9 Bayonet"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel = "models/weapons/v_bf3_knife.mdl"
SWEP.WorldModel = "models/weapons/rinfect/battlefield_3/knives/standardknife.mdl"
SWEP.ShowViewModel = true
SWEP.ShowWorldModel = true

if CLIENT then
killicon.Add("m9_bayonet", "vgui/hud/m9_bayonet", Color(255, 255, 255, 255))
SWEP.SelectIcon = surface.GetTextureID("vgui/hud/m9_bayonet")
end

SWEP.ViewModelBoneMods = {
	["Knife.Dummy"] = { scale = Vector(1.189, 1.189, 1.189), pos = Vector(-0.635, 0, 0), angle = Angle(24.761, 0, 0) }
}
SWEP.Base				= "bob_gun_base"
SWEP.Spawnable				= true
...
SWEP.RunSightsAng = Vector(-100, 0, 0)
...
SWEP.Primary.Sound	= Sound("weapons/m9 bayonet/knife_slash1.wav") //woosh
SWEP.KnifeShink = Sound("Weapon_Knife.HitWall")
SWEP.KnifeSlash = Sound("weapons/m9 bayonet/knife_slash2.wav")
SWEP.KnifeStab = Sound("weapons/m9 bayonet/knife_hit1.wav")

function SWEP:Deploy()

	self.Weapon:SendWeaponAnim( ACT_VM_DRAW )
	self.Weapon:SetNextPrimaryFire(CurTime() + 1)
	if file.Exists("weapons/Premium mk21/knife_deploy1.wav", "GAME") then
		self.Weapon:EmitSound("weapons/Premium mk21/knife_deploy1.wav", 50, 100)
	end
	return true
end
