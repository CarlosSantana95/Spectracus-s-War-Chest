...
if CLIENT then
	...
	SWEP.PrintName = "Pimp PKM"
	SWEP.CSMuzzleFlashes = true
	
	killicon.Add("weapon_pimppkm", "vgui/hud/weapon_pimppkm", Color(255, 255, 255, 255))
	SWEP.SelectIcon = surface.GetTextureID("vgui/hud/weapon_pimppkm")
	...
	SWEP.WM = "models/alraekinn/weapons/pim/pkm.mdl"
...
SWEP.Contact		= ""
SWEP.Purpose		= "Yo dawg, heard this Spectracus dude wanted to tune up his boomstick so I installed a new paint job and better ammo so he can be pimpin' while killin'... Caliber: 7.62x54mm SWAG Round"
SWEP.Instructions	= ""

SWEP.IronFOV		= 80
SWEP.ViewModelFOV	= 80
SWEP.ViewModelFlip	= false
SWEP.ViewModel		= "models/weapons/v_lmg_pimpedrpk.mdl"
